...
public class GlobalExceptionHandler {
    ...
    public CommonResult<?> methodArgumentTypeInvalidFormatExceptionHandler(HttpMessageNotReadableException ex) {
        ...
        if (ex.getCause() instanceof MismatchedInputException) {
            ...
            return CommonResult.error(BAD_REQUEST.getCode(),
                    String.format("请求参数类型错误，字段 [%s] 应该是 %s 类型", fieldName, targetType));
        }
    ...
    public CommonResult<?> defaultExceptionHandler(HttpServletRequest req, Throwable ex) {
        ...
        return CommonResult.error(INTERNAL_SERVER_ERROR.getCode(), MessageUtils.message("INTERNAL_SERVER_ERROR"));
    }

...
import static cn.iocoder.yudao.framework.apilog.core.interceptor.ApiAccessLogInterceptor.TRACE_ID;
...
public class ApiAccessLogFilter extends ApiRequestFilter {
    ...
    private boolean buildApiAccessLog(ApiAccessLogCreateReqDTO accessLog, HttpServletRequest request, LocalDateTime beginTime,
        ...
        if(!ObjectUtil.isEmpty(queryString)) {
            traceId=  queryString.get(TRACE_ID);
        }
        ...
        // 设置请求字段
        accessLog.setTraceId(traceId).setApplicationName(applicationName)

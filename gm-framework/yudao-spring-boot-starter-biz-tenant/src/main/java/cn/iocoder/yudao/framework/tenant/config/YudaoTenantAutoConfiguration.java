...
import cn.iocoder.yudao.framework.tenant.core.db.CustomTenantLineInnerInterceptor;
...
public class YudaoTenantAutoConfiguration {
    ...
    public TenantLineInnerInterceptor tenantLineInnerInterceptor(TenantProperties properties,
        ...
        TenantLineInnerInterceptor inner = new CustomTenantLineInnerInterceptor(new TenantDatabaseInterceptor(properties, tenantApi));
        // 添加到 interceptor 中

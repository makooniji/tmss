...
const remainingRouter: AppRouteRecordRaw[] = [
    ...
    children: [
      ...
      },
      {
        ...
        meta: {
          ...
          noTagsView: false,
          icon: 'ep:message',
          title: t('system.notifyMessage.myMailboxTitle')
        }
      }
    ]
  },
  ...
  },
  {
    ...
    children: [
      {
        path: 'gameTest',
        component: () => import('@/views/tools/gameTest/index.vue'),
        name: 'ToolsGameTest',
        meta: {
          title: t('tools.gameTest.title'),
          icon: 'ep:cpu',
          noCache: false,
          hidden: false,
          canTo: true
      ...
      {
        path: 'sportsTest',
        component: () => import('@/views/tools/sportsTest/index.vue'),
        name: 'ToolsSportsTest',
        meta: {
          title: t('tools.sportsTest.title'),
          icon: 'ep:trophy',
          noCache: false,
          hidden: false,
          canTo: true
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () =>
          import('@/views/mall/product/property/value/index.vue'),
    ...
    children: [
      {
        ...
        component: () =>
          import('@/views/mall/promotion/diy/template/decorate.vue')
      },
      {

<template>
  <div>
    <el-divider content-position="left">{{
      t('bpmn.boundaryTimer.dividerTitle')
    }}</el-divider>
    <el-form-item
      :label="t('bpmn.boundaryTimer.enableSwitch')"
    ...
    <el-form-item
      :label="t('bpmn.boundaryTimer.action')"
    ...
    <el-form-item
      :label="t('bpmn.boundaryTimer.timeoutSetting')"
      v-if="timeoutHandlerEnable"
    >
      <span class="mr-2">{{ t('bpmn.boundaryTimer.whenExceed') }}</span>
      ...
      {{ t('bpmn.boundaryTimer.unprocessed') }}
    </el-form-item>
    <el-form-item
      :label="t('bpmn.boundaryTimer.maxRemind')"
      prop="maxRemindCount"

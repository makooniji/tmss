...
<script setup lang="ts">
  ...
  const showUserTaskNodeConfig = (node: SimpleFlowNode) => {
    ...
    configForm.value.assignStartUserHandlerType =
      node.assignStartUserHandlerType
    // 3. 操作按钮设置

<template>
    ...
    >
      ...
      <el-form-item :label="t('system.dept.deptStatus')" prop="status">
        <el-select
          ...
          :placeholder="t('system.dept.selectDeptStatus')"
          clearable
          class="!w-240px"
        >
          <el-option
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-table-column prop="name" :label="t('system.dept.deptName')" />
      <el-table-column prop="leader" :label="t('system.dept.leader')">
        <template #default="scope">
          {{
            userList.find((user) => user.id === scope.row.leaderUserId)
              ?.nickname
          }}
        </template>
      </el-table-column>

    ...
    >
      ...
      <el-form-item :label="t('system.dictType.type')" prop="type">
        <el-input
          ...
          :placeholder="t('system.dictType.placeholderParam')"
        />
      </el-form-item>
      ...
      <el-form-item :label="t('form.remark')" prop="remark">
        <el-input
          ...
          :placeholder="t('system.dictType.remarkPlaceholder')"
          type="textarea"
        />
      </el-form-item>
    </el-form>
...
<script lang="ts" setup>
  ...
  const formRules = computed(() => ({
    name: [
      {
        required: true,
        message: t('system.dictType.nameRequired'),
        trigger: 'blur'
      }
    ],
    type: [
      {
        required: true,
        message: t('system.dictType.typeRequired'),
        trigger: 'blur'
      }
    ],
    status: [
      {
        required: true,
        message: t('system.dictType.statusRequired'),
        trigger: 'change'
      }
    ]
  }))

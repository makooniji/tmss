<template>
  <ContentWrap>
    ...
    >
      <el-form-item :label="t('system.dictData.dictTypeName')" prop="dictType">
        <el-select
      ...
      <el-form-item :label="t('system.dictData.label')" prop="label">
        <el-input
          v-model="queryParams.label"
          :placeholder="t('system.dictData.placeholderLabel')"
          clearable
...
<script lang="ts" setup>
  ...
  const handleExport = async () => {
    try {
      ...
      download.excel(data, t('system.dictData.exportFile'))
    } catch {
    } finally {

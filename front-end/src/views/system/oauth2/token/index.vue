<template>
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item :label="t('system.oauth2Token.userType')" prop="userType">
        <el-select
          v-model="queryParams.userType"
          :placeholder="t('system.oauth2Token.selectUserType')"
          clearable
          class="!w-240px"
        >
          <el-option
      ...
      <el-form-item :label="t('system.oauth2Token.clientId')" prop="clientId">
        <el-input
          v-model="queryParams.clientId"
          :placeholder="t('system.oauth2Token.placeholderClientId')"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      <el-table-column
        :label="t('system.oauth2Token.accessToken')"
        align="center"
        prop="accessToken"
        width="300"
      />
      <el-table-column
        :label="t('system.oauth2Token.refreshToken')"
        align="center"
        prop="refreshToken"
        width="300"
      />
      ...
      />
      <el-table-column
        :label="t('system.oauth2Token.userType')"
        align="center"
        prop="userType"
      >
      ...
      <el-table-column
        :label="t('system.oauth2Token.expiresTime')"
        align="center"
        prop="expiresTime"
      ...
      <el-table-column :label="t('table.action')" align="center">
        <template #default="scope">
          ...
          >
            {{ t('system.oauth2Token.forceLogout') }}
          </el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script lang="ts" setup>
  ...
  const handleForceLogout = async (accessToken: string) => {
    try {
      // 删除的二次确认
      await message.confirm(t('system.oauth2Token.confirmForceLogout'))
      // 发起删除

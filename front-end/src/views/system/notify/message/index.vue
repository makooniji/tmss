<template>
    ...
    >
      ...
      <el-form-item :label="t('system.notifyMessage.userType')" prop="userType">
        <el-select
          ...
          :placeholder="t('system.notifyMessage.selectUserType')"
          clearable
          class="!w-240px"
        >
          <el-option
      ...
      >
        <el-input
          ...
          :placeholder="t('system.notifyMessage.placeholderTemplateCode')"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
      ...
      >
        <el-select
          ...
          :placeholder="t('system.notifyMessage.selectTemplateType')"
          clearable
          class="!w-240px"
        >
          <el-option
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      ...
      />
      <el-table-column
        :label="t('system.notifyMessage.userType')"
        align="center"
        prop="userType"
      >
      ...
      />
      <el-table-column
        :label="t('system.notifyMessage.senderName')"
        align="center"

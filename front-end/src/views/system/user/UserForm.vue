        ...
        <el-col :span="12">
          <el-form-item :label="t('system.user.deptId')" prop="deptId">
            <el-tree-select
              ...
              check-strictly
              node-key="id"
              :placeholder="t('system.user.placeholderDept')"
            />
          </el-form-item>
        </el-col>
      </el-row>
        ...
        <el-col :span="12">
          <el-form-item :label="t('system.user.mobile')" prop="mobile">
            <el-input
              ...
              maxlength="11"
              :placeholder="t('system.user.placeholderMobile')"
            />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="t('system.user.email')" prop="email">
            <el-input
              ...
              maxlength="50"
              :placeholder="t('system.user.placeholderEmail')"
            />
          </el-form-item>
        </el-col>
      </el-row>
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              ...
              :placeholder="t('system.user.placeholderUserPassword')"
              show-password
              type="password"
            />
          </el-form-item>
        ...
        <el-col :span="12">
          <el-form-item :label="t('system.user.sex')">
            <el-select
              ...
              :placeholder="t('system.user.selectPlaceholder')"
            >
              <el-option
...
<script lang="ts" setup>
  ...
  const open = async (type: string, id?: number) => {
    ...
    dialogTitle.value =
      type === 'create'
        ? t('system.user.dialogCreate')
        : type === 'update'
          ? t('system.user.dialogUpdate')
          : t('action.' + type)
    formType.value = type
    resetForm()
    // 修改时，设置数据

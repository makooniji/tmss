<template>
  <!-- 搜索工作栏 -->
  <ContentWrap>
    <el-form class="-mb-15px" ref="queryFormRef" :inline="true" >
    ...
    <div class="clearfix public-account-management" v-loading="loading">
      ...
      <div class="left">
        ...
        <div class="clearfix weixin-menu">
          <MenuPreviewer v-model="menuList" :account-id="accountId" :active-index="activeIndex"
            :parent-index="parentIndex" @menu-clicked="(parent, x) => menuClicked(parent, x)"

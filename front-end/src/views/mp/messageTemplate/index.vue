<template>
  <ContentWrap>
    ...
    <el-form class="-mb-15px" :model="queryParams" ref="queryFormRef" :inline="true" >
      ...
      <el-form-item>
        <el-button type="success" plain @click="handleSync" :loading="syncLoading"
          v-hasPermi="['mp:message-template:sync']" :disabled="queryParams.accountId === -1">
    ...
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      ...
      <el-table-column label="操作" align="center" width="160">
        <template #default="scope">
          <el-button link type="primary" @click="handleSend(scope.row)" v-hasPermi="['mp:message-template:send']">
            发送
          </el-button>
          <el-button link type="danger" @click="handleDelete(scope.row.id)" v-hasPermi="['mp:message-template:delete']">
            删除
          </el-button>
        </template>
      </el-table-column>

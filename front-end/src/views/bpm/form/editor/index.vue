<template>
  ...
  <Dialog
    ...
    :title="t('bpm.formEditor.saveDialogTitle')"
    width="600"
  >
    <el-form
      ref="formRef"
      ...
      label-width="100px"
    >
      <el-form-item :label="t('bpm.formEditor.formName')" prop="name">
        <el-input
          v-model="formData.name"
          :placeholder="t('bpm.formEditor.formNamePlaceholder')"
        />
      </el-form-item>
      <el-form-item :label="t('bpm.formEditor.status')" prop="status">
      ...
      <el-form-item :label="t('bpm.formEditor.remark')" prop="remark">
        <el-input
          v-model="formData.remark"
          :placeholder="t('bpm.formEditor.remarkPlaceholder')"
          type="textarea"
        />
      </el-form-item>
    </el-form>
...
<script lang="ts" setup>
  ...
  const formRules = computed(() => ({
    name: [
      {
        required: true,
        message: t('bpm.formEditor.nameRequired'),
        trigger: 'blur'
      }
    ],
    status: [
      {
        required: true,
        message: t('bpm.formEditor.statusRequired'),
        trigger: 'blur'
      }
    ]
  }))

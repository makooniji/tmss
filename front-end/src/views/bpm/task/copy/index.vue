...
<template>
  <ContentWrap>
    <!-- 搜索工作栏 -->
    <el-form ref="queryFormRef" :inline="true" class="-mb-15px" >
      <el-form-item label="流程名称" prop="name">
        <el-input v-model="queryParams.processInstanceName" @keyup.enter="handleQuery" class="!w-240px" clearable
          placeholder="请输入流程名称" />
      </el-form-item>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column :formatter="dateFormatter" align="center" label="流程发起时间" prop="processInstanceStartTime"
        width="180" />

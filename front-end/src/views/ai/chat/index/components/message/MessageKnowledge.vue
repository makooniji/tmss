    ...
    <div class="flex flex-wrap gap-8px">
      ...
      >
        <div class="text-14px text-[#333] mb-4px">
          {{ doc.title }}
          <span class="text-12px text-[#999] ml-4px">{{
            t('aiChat.knowledge.segmentsCount', { count: doc.segments.length })
          }}</span>
        </div>
      </div>
    </div>
    ...
    <template #default>
      ...
      <div class="max-h-[60vh] overflow-y-auto">
        ...
        >
          ...
          >
            {{ t('aiChat.knowledge.segmentLabel', { id: segment.id }) }}
          </div>

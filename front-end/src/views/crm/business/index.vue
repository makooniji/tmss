<template>
  <ContentWrap>
    ...
    <el-form ref="queryFormRef" :inline="true" :model="queryParams" class="-mb-15px" >
      <el-form-item label="商机名称" prop="name">
        <el-input v-model="queryParams.name" class="!w-240px" clearable placeholder="请输入商机名称"
      ...
      <el-form-item>
        ...
        <el-button v-hasPermi="['crm:business:export']" :loading="exportLoading" plain type="success"
          @click="handleExport">
  ...
  <ContentWrap>
    ...
    <el-table v-loading="loading" :data="list" :show-overflow-tooltip="true" :stripe="true">
      ...
      <el-table-column :formatter="erpPriceTableColumnFormatter" align="center" label="商机金额（元）" prop="totalPrice"
        width="140" />
      ...
      <el-table-column align="center" fixed="right" label="操作" width="130px">
        <template #default="scope">
          <el-button v-hasPermi="['crm:business:update']" link type="primary" @click="openForm('update', scope.row.id)">
            编辑
          </el-button>
          <el-button v-hasPermi="['crm:business:delete']" link type="danger" @click="handleDelete(scope.row.id)">
            删除
          </el-button>
        </template>
      </el-table-column>

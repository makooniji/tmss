  ...
  <ContentWrap>
    ...
    <el-form ref="queryFormRef" :inline="true" :model="queryParams" class="-mb-15px" >
      ...
      <el-form-item label="姓名" prop="name">
        <el-input v-model="queryParams.name" class="!w-240px" clearable placeholder="请输入姓名"
          @keyup.enter="handleQuery" />
      </el-form-item>
      <el-form-item label="手机号" prop="mobile">
        <el-input v-model="queryParams.mobile" class="!w-240px" clearable placeholder="请输入手机号"
          @keyup.enter="handleQuery" />
      </el-form-item>
      <el-form-item label="电话" prop="telephone">
        <el-input v-model="queryParams.telephone" class="!w-240px" clearable placeholder="请输入电话"
          @keyup.enter="handleQuery" />
      </el-form-item>
      <el-form-item label="微信" prop="wechat">
        <el-input v-model="queryParams.wechat" class="!w-240px" clearable placeholder="请输入微信"
          @keyup.enter="handleQuery" />
      </el-form-item>
      <el-form-item label="电子邮箱" prop="email">
        <el-input v-model="queryParams.email" class="!w-240px" clearable placeholder="请输入电子邮箱"
          @keyup.enter="handleQuery" />
      </el-form-item>
      <el-form-item>
        ...
        <el-button v-hasPermi="['crm:contact:export']" :loading="exportLoading" plain type="success"
          @click="handleExport">
  ...
  <ContentWrap>
    ...
    <el-table v-loading="loading" :data="list" :show-overflow-tooltip="true" :stripe="true">
      ...
      <el-table-column align="center" fixed="right" label="操作" width="200">
        <template #default="scope">
          <el-button v-hasPermi="['crm:contact:update']" link type="primary" @click="openForm('update', scope.row.id)">
            编辑
          </el-button>
          <el-button v-hasPermi="['crm:contact:delete']" link type="danger" @click="handleDelete(scope.row.id)">
            删除
          </el-button>
        </template>
      </el-table-column>

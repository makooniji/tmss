    ...
    <el-table v-loading="loading" :data="list" row-key="id" default-expand-all>
      ...
      <el-table-column label="操作" align="center" min-width="180">
        <template #default="scope">
          ...
          <el-button link type="primary" v-if="scope.row.parentId > 0" @click="handleViewSpu(scope.row.id)"
            v-hasPermi="['product:spu:query']">
            查看商品
          </el-button>
          <el-button link type="danger" @click="handleDelete(scope.row.id)" v-hasPermi="['product:category:delete']">
            删除
          </el-button>
        </template>
      </el-table-column>

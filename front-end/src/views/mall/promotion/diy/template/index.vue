  ...
  <ContentWrap>
    ...
    <el-form class="-mb-15px" :model="queryParams" ref="queryFormRef" :inline="true" >
      ...
      <el-form-item>
        ...
        <el-button type="primary" plain @click="openForm('create')" v-hasPermi="['promotion:diy-template:create']">
      ...
      <el-table-column label="操作" align="center" width="200">
        <template #default="scope">
          ...
          <template v-if="!scope.row.used">
            <el-button link type="primary" @click="handleUse(scope.row)" v-hasPermi="['promotion:diy-template:use']">
              使用
            </el-button>

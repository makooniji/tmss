<template>
  ...
  <ContentWrap>
    <el-form ref="queryFormRef" :inline="true" :model="queryParams" class="-mb-15px" >
      <el-form-item label="活动名称" prop="name">
        <el-input v-model="queryParams.name" class="!w-240px" clearable placeholder="请输入活动名称"
      ...
      <el-form-item label="活动时间" prop="createTime">
        <el-date-picker v-model="queryParams.createTime"
          :default-time="[new Date('1 00:00:00'), new Date('1 23:59:59')]" class="!w-240px" end-placeholder="活动结束日期"
          start-placeholder="活动开始日期" type="daterange" value-format="YYYY-MM-DD HH:mm:ss" />
      </el-form-item>
      <el-form-item>
        ...
        <el-button v-hasPermi="['promotion:reward-activity:create']" plain type="primary" @click="openForm('create')">
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" default-expand-all row-key="id">
      ...
      <el-table-column :formatter="dateFormatter" align="center" label="活动开始时间" prop="startTime" />
      <el-table-column :formatter="dateFormatter" align="center" label="活动结束时间" prop="endTime" />
      ...
      <el-table-column align="center" label="操作">
        <template #default="scope">
          <el-button v-hasPermi="['promotion:reward-activity:update']" link type="primary"
            @click="openForm('update', scope.row.id)">
            编辑
          </el-button>
          <el-button v-if="scope.row.status === 0" v-hasPermi="['promotion:reward-activity:close']" link type="danger"
            @click="handleClose(scope.row.id)">
            关闭
          </el-button>
          <el-button v-hasPermi="['promotion:reward-activity:delete']" link type="danger"

  ...
  <ContentWrap>
    <el-form ref="queryFormRef" :inline="true" :model="queryParams" class="-mb-15px">
      <el-form-item label="门店手机" prop="phone">
        <el-input v-model="queryParams.phone" class="!w-240px" clearable placeholder="请输门店手机"
          @keyup.enter="handleQuery" />
      </el-form-item>
      <el-form-item label="门店名称" prop="name">
        <el-input v-model="queryParams.name" class="!w-240px" clearable placeholder="请输门店名称"
          @keyup.enter="handleQuery" />
      </el-form-item>
      ...
      <el-form-item label="创建时间" prop="createTime">
        <el-date-picker v-model="queryParams.createTime" class="!w-240px" end-placeholder="结束日期"
      ...
      <el-form-item>
        ...
        <el-button v-hasPermi="['trade:delivery:pick-up-store:create']" plain type="primary"
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column align="center" label="操作" min-width="110">
        <template #default="scope">
          <el-button v-hasPermi="['trade:delivery:pick-up-store:update']" link type="primary"
          ...
          <el-button v-hasPermi="['trade:delivery:pick-up-store:delete']" link type="danger"

  ...
  <div class="flex flex-col">
    <el-row :gutter="16" class="summary">
      <el-col v-loading="loading" :sm="6" :xs="12">
        <SummaryCard :value="summary?.userCount || 0" icon="fa-solid:users" icon-bg-color="text-blue-500"
          icon-color="bg-blue-100" title="累计会员数" />
      </el-col>
      <el-col v-loading="loading" :sm="6" :xs="12">
        <SummaryCard :value="summary?.rechargeUserCount || 0" icon="fa-solid:user" icon-bg-color="text-purple-500"
          icon-color="bg-purple-100" title="累计充值人数" />
      </el-col>
      <el-col v-loading="loading" :sm="6" :xs="12">
        <SummaryCard :decimals="2" :value="fenToYuan(summary?.rechargePrice || 0)" icon="fa-solid:money-check-alt"
          icon-bg-color="text-yellow-500" icon-color="bg-yellow-100" prefix="￥" title="累计充值金额" />
      </el-col>
      <el-col v-loading="loading" :sm="6" :xs="12">
        <SummaryCard :decimals="2" :value="fenToYuan(summary?.expensePrice || 0)" icon="fa-solid:yen-sign"
          icon-bg-color="text-green-500" icon-color="bg-green-100" prefix="￥" title="累计消费金额" />
      </el-col>
    </el-row>
          ...
          <el-row v-loading="loading">
            ...
            <el-col :span="14">
              <el-table :data="areaStatisticsList" :height="300">
                <el-table-column :sort-method="(obj1, obj2) => obj1.areaName.localeCompare(obj2.areaName, 'zh-CN')"
                  align="center" label="省份" min-width="80" prop="areaName" show-overflow-tooltip sortable />
                ...
                <el-table-column :formatter="fenToYuanFormat" align="center" label="订单支付金额" min-width="135"
                  prop="orderPayPrice" sortable />
              </el-table>
            </el-col>
          </el-row>
        </el-card>

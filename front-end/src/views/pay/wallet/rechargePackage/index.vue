<template>
    ...
    >
      ...
      <el-form-item>
        <el-button @click="handleQuery"
          ...
          {{ t('game.common.search') }}</el-button
        >
  ...
  <ContentWrap>
    ...
    >
      <el-table-column
        :label="t('walletRechargePackage.idColumn')"
        align="center"
        prop="id"
      />
      <el-table-column
        :label="t('walletRechargePackage.packageName')"
        align="center"
        prop="name"
      />
      <el-table-column
        :label="t('walletRechargePackage.payPrice')"
        align="center"
        prop="payPrice"
      >
        <template #default="{ row }">
          {{ fenToYuan(row.payPrice) }}
          {{ t('walletRechargePackage.yuanSuffix') }}</template
        >
      </el-table-column>
      <el-table-column
        :label="t('walletRechargePackage.bonusPrice')"
        align="center"
        prop="bonusPrice"
      >
        <template #default="{ row }">
          {{ fenToYuan(row.bonusPrice) }}
          {{ t('walletRechargePackage.yuanSuffix') }}</template
        >
      </el-table-column>
...
<script setup lang="ts">
  ...
  const getList = async () => {
    ...
    try {
      const data =
        await WalletRechargePackageApi.getWalletRechargePackagePage(queryParams)

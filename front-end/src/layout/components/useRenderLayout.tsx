...
export const useRenderLayout = () => {
        ...
        >
          ...
          >
            <div
              ...
              style="transition: all var(--transition-time-02);box-shadow: 0 2px 8px #0000001a;"
            >
              <ToolHeader
                class={[
              ...
              {tagsView.value ? (
                <TagsView class="layout-border__top"></TagsView>
              ) : undefined}
            </div>
  ...
  const renderTopLeft = () => {
    return (
      <>
        <div class="relative flex items-center bg-[var(--top-header-bg-color)] dark:bg-[var(--el-bg-color)]" style="    z-index: 1000;

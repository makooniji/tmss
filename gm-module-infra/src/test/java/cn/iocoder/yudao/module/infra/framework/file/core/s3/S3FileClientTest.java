...
//        config.setAccessKey(System.getenv("QINIU_ACCESS_KEY"));
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        config.setAccessKey("AKIARH7FS4FE6ODOAVMD");
        config.setAccessSecret("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");
        config.setBucket("yingshan");
        config.setDomain("https://cdn.iaming-fun.com"); // 如果有自定义域名，则可以设置。http://static.yudao.iocoder.cn
        config.setEnablePathStyleAccess(false);

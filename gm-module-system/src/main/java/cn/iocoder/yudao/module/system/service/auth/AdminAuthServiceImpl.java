...
public class AdminAuthServiceImpl implements AdminAuthService {
    ...
    public AuthLoginRespVO login(AuthLoginReqVO reqVO) {
        ...
        // 创建 Token 令牌，记录登录日志
        return createTokenAfterLoginSuccess(user.getId(), reqVO.getUsername(), LoginLogTypeEnum.LOGIN_USERNAME, user.getTenantId());
    }
    ...
    public AuthLoginRespVO smsLogin(AuthSmsLoginReqVO reqVO) {
        ...
        // 创建 Token 令牌，记录登录日志
        return createTokenAfterLoginSuccess(user.getId(), reqVO.getMobile(), LoginLogTypeEnum.LOGIN_MOBILE, user.getTenantId());
    }
    ...
    public AuthLoginRespVO socialLogin(AuthSocialLoginReqVO reqVO) {
        ...
        // 创建 Token 令牌，记录登录日志
        return createTokenAfterLoginSuccess(user.getId(), user.getUsername(), LoginLogTypeEnum.LOGIN_SOCIAL, user.getTenantId());
    }
    ...
    private AuthLoginRespVO createTokenAfterLoginSuccess(Long userId, String username, LoginLogTypeEnum logType, Long tenantId) {
        ...
        // 构建返回结果
        AuthLoginRespVO bean = BeanUtils.toBean(accessTokenDO, AuthLoginRespVO.class);
    ...
    public AuthLoginRespVO register(AuthRegisterReqVO registerReqVO) {
        ...
        return createTokenAfterLoginSuccess(userId, registerReqVO.getUsername(), LoginLogTypeEnum.LOGIN_USERNAME, 1L);
    }

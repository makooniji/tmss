...
public interface ErrorCodeConstants {
    ...
    ErrorCode VENDOR_NOT_EXISTS = new ErrorCode(601, "游戏厂商不存在");
    ErrorCode RECORDS_NOT_EXISTS = new ErrorCode(602, "用户游戏记录不存在");
    ErrorCode VENDOR_USER_NOT_EXISTS = new ErrorCode(603, "厂商玩家不存在");
    ErrorCode CATEGORY_NOT_EXISTS = new ErrorCode(604, "游戏大类不存在");
    ErrorCode TENANT_DAY_STATIC_NOT_EXISTS = new ErrorCode(605, "租户游戏日报不存在");
    ErrorCode INFO_NOT_EXISTS = new ErrorCode(606, "游戏信息不存在");
    ErrorCode CATEGORY_SUB_NOT_EXISTS = new ErrorCode(607, "游戏分类不存在");
    ErrorCode VENDOR_TENANT_NOT_EXISTS = new ErrorCode(608, "租户厂商不存在");
    ...
    ErrorCode TENANT_PARENT_NOT_EXISTS = new ErrorCode(1_002_015_006, "所属租户不存在");
    ErrorCode TENANT_PARENT_ERROR = new ErrorCode(1_002_015_007, "不能设置自己为所属租户");
    ErrorCode TENANT_PARENT_IS_AGENT = new ErrorCode(1_002_015_008, "代理不能作为所属租户");
    ErrorCode TENANT_EXISTS_CHILDREN = new ErrorCode(1_002_015_009, "存在直属代理，无法删除");
    ErrorCode TENANT_VISIBLE_FORBIDDEN = new ErrorCode(1_002_015_010, "无权访问该租户");
    ErrorCode TENANT_AGENT_PACKAGE_ERROR = new ErrorCode(1_002_015_011, "子代理不能绑定商户套餐");

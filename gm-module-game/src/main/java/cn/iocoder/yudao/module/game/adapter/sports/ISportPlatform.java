package cn.iocoder.yudao.module.game.adapter.sports;
...
public interface ISportPlatform extends IPlatform {
     ...
     * @return 平台响应
     */
    PlatformResponse<Object> forward(ActionEnum type, PlatformRequest requestData);
